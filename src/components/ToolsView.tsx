...
export const ToolsView: React.FC<ToolsViewProps> = ({ tools }) => {
  ...
  const getAvailability = (tool: Tool) => {
    ...
    return {
      label: tool.status || 'NO COMPROBADA',
      className:
    ...
    <div className="space-y-6">
      ...
      <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800">
        ...
        <p className="text-xs text-slate-400 mt-1 leading-relaxed">
          ...
          Cada operación está sujeta a las validaciones y límites definidos
          por el servidor.
        </p>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between gap-3 pt-3 border-t border-slate-800/80">
                  ...
                  <span
                    className={`px-2 py-1 rounded text-[10px] font-bold border ${availability.className}`}
                  >
                    {availability.label}
                  </span>
                </div>
